...
def biPow(B,e):
    ...
    elif e%2==0:return biPow(B*B,e/2)
    elif e%2==1:return B*biPow(B*B,(e-1)/2)
...
#source=[7,23]
   ...
   # print str(format(12,'08b'))
    ...
    +"cG91bHkgPG5pY2tlY29ub3BvdWx5QGdtYWlsLmNvjT6JARwEEAEKAAYFAlUhO7wACgkQ0Jfx++=")
    #'''
    print L
    PP=deBase64Bin(L)
    print PP[0:len(PP)/2],
    ...
    print index64('B')# there is no reason why this big 10000.... number should be this number in particular math.sqrt() just doesn't accept super big numbers
    '''
    d=int(math.floor(math.sqrt(K/
          ...
          '''
    d=findCoprime(K)
    print "is Coprime???? "+ str(gcd(K,d)==1)+"!!!"
